...
install.packages("qqman",repos="https://CRAN.R-project.org/",lib="~" ) # location of installation can be changed but has to correspond with the library library location
